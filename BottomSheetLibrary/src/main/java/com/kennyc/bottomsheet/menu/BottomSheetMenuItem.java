...
public class BottomSheetMenuItem implements MenuItem {
     ...
     */
    public BottomSheetMenuItem(Context context, int group, int id, int categoryOrder, int ordering, CharSequence title,Object o) {
        mContext = context;
        mId = id;
        mGroup = group;
    ...
    public BottomSheetMenuItem(Context context, int group, int id, int categoryOrder, int ordering, CharSequence title,@DrawableRes int icon) {
        mContext = context;
        mId = id;
        mGroup = group;
        mCategoryOrder = categoryOrder;
    ...
    public BottomSheetMenuItem(Context context, int group, int id, int categoryOrder, int ordering, CharSequence title,  Drawable icon) {
        mContext = context;
        mId = id;
        mGroup = group;
        mCategoryOrder = categoryOrder;
    ...
    public BottomSheetMenuItem(Context context, CharSequence title, @DrawableRes int icon) {
        this(context, 0, 0, 0, 0, title,icon);
        setIcon(icon);
    }
    ...
    public BottomSheetMenuItem(Context context, int id, CharSequence title, @DrawableRes int icon) {
        this(context, 0, id, 0, 0, title,icon);
        setIcon(icon);
    }
    ...
    public MenuItem setTag(Object o) {
        tag = 0;
        return this;
    }
