...
public class BottomSheetMenu implements Menu {
    ...
    public MenuItem add(int groupId, int itemId, int order, CharSequence title, Object o) {
        BottomSheetMenuItem item = new BottomSheetMenuItem(getContext(), groupId, itemId, 0, order, title, o);
        // TODO Order is ignored here.
        mItems.add(item);
        return item;
    }

    public MenuItem add(int groupId, int itemId, int order, CharSequence title, @DrawableRes int icon) {
        BottomSheetMenuItem item = new BottomSheetMenuItem(getContext(), groupId, itemId, 0, order, title, icon);
        // TODO Order is ignored here.
        mItems.add(item);
        return item;
    }

    public MenuItem add(int groupId, int itemId, int order, CharSequence title, Drawable icon) {
        BottomSheetMenuItem item = new BottomSheetMenuItem(getContext(), groupId, itemId, 0, order, title, icon);
        // TODO Order is ignored here.
        mItems.add(item);
        return item;
